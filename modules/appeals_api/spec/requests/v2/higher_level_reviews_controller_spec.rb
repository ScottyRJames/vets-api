...
describe AppealsApi::V2::DecisionReviews::HigherLevelReviewsController, type: :request do
  ...
  before(:all) do
    ...
    @invalid_characters_headers = fixture_as_json 'invalid_200996_headers_v2_characters.json'
    @invalid_characters_data = fixture_as_json 'invalid_200996_v2_characters.json'
  end
